...
export TBBLIBDIR=$PAR_STUDIO/compilers_and_libraries_2016/linux/tbb/lib/intel64/gcc4.4
export TBBINCDIR=$PAR_STUDIO/compilers_and_libraries_2016/linux/tbb/include
...
PK_FCFLAGS=${OMPFLAGS}" -O3 -xAVX -mkl -qopt-report -qopt-report-phase=openmp,vec"
