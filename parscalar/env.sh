...
export PATH=/usr/mpi/gcc/mvapich2-2.0rc1/bin:$PATH
export PATH=/dist/gcc-4.8.2/bin:$PATH
export LD_LIBRARY_PATH=/dist/gcc-4.8.2/lib64:/dist/gcc-4.8.2/lib:/usr/mpi/gcc/mvapich2-1.8/lib:$LD_LIBRARY_PATH
...
### COMPILER FLAGS
PK_CXXFLAGS=${OMPFLAGS}" -O2 -std=c++11 -march=corei7-avx"

PK_CFLAGS=${OMPFLAGS}" -O2 -march=corei7-avx -std=gnu99"
